    ...
    <div className="flex flex-col justify-center items-start p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 text-white h-full w-full">
      ...
      <div className="space-y-3 sm:space-y-4 w-full max-w-sm">
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-green-400 flex-shrink-0"></span>
          <span className="text-sm sm:text-base md:text-lg">Military-grade encryption</span>
        </div>
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-blue-400 flex-shrink-0"></span>
